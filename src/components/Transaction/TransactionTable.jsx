            ...
            <tbody className="divide-y divide-gray-700">
              {currentItems.map((transaction) => (
                <motion.tr key={transaction.id} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3 }}>
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-black truncate max-w-xs">{transaction.transactionNo}</td>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-black hidden sm:table-cell">{transaction.coinsInWallet}</td>
